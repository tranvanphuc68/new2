        ...
        <div class="mx-auto d-flex justify-content-end row">
            <form method="GET" >
                <div class="input-group">
                    <input type="text" class="form-control mr-3 search" name="search" value="<?php if (isset($_GET['search'])) { echo $_GET['search'];} ?>" placeholder="Search by post title" class="search">
                </div>
            </form>
        </div>
        <!-- /search -->
