                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="card-title-block" id="create">
                                <a class="d-left" href="{{ url("/fees/edit/{$students[0]->id_course}") }}"><img src="{{ asset('assets/img/icon-plus.png') }}" class="mw-45" alt=""><span class="fz-24">Cập nhật học phí</span></a>
