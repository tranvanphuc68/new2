                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="card-title-block">
                                <a class="d-left" href="{{ url("/users/teacher/create") }}"><img src="{{ asset('assets/img/icon-plus.png') }}" style="max-width: 45px" alt=""><span style="font-size:20px">Thêm giảng viên</span></a>
