        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links" data-aos="fade-up" data-aos-delay="150">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Diễn đàn</a></li>
          ...
          <div class="col-lg-2 col-md-6 footer-links" data-aos="fade-up" data-aos-delay="250">
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Cảm nhận của học viên</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Đội ngũ giảng viên</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Đăng kí thi thử</a></li>
            </ul>
          </div>
